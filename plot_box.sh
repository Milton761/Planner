...
set terminal pdf
set output 'boxes_stVisited.pdf'
...
set terminal pdf
set output 'boxes_stExpanded.pdf'
...
set terminal pdf
set output 'boxes_penetrance.pdf'
